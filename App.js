...
function App() {
  ...
  // NUEVO: Estados para manejar el formulario profesional
  ...
  // NUEVO: Manejador de los inputs del formulario
  ...
  // NUEVO: Función para guardar con el formulario (reemplaza a los window.prompt)
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Limpiamos y ocultamos el formulario, luego recargamos la lista
  ...
  const filteredServices = services.filter(s => {
    // Escudo protector contra datos viejos sin nombre
    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
        ...
        <div className="content-body">
          ...
          {/* NUEVO: Formulario Integrado (Solo aparece si showForm es true) */}
          {showForm && (
            <div style={{
